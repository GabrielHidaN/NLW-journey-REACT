      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="h-16  bg-zinc-900 px-4 rounded-xl flex items-center gap-3 shadow-shape">
          ...
          <div className="flex items-center gap-2">
            ...
            <input type="text" placeholder="Quando?" className="bg-transparent text-lgt placeholder-zinc-400 w-40 outline-none"/>
          </div>

          <div className="w-px h-6 bg-zinc-800"/>
          <button className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400" >Continuar <ArrowRight className="size-5 "/></button>
        </div>
